  ...
  return (
    <DeviceFrame
      fixedOverlay={
        ...
        // Passed as fixedOverlay (a sibling of the scrollable children, not
        // inside them) because it's position:fixed and anchors to
        // .app-frame itself (see App.css) — it must stay out of the
        // scrollable content or it'd scroll away with it.
        <UpdatePrompt />
      }
    >
